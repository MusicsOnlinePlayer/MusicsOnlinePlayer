...
namespace Musics___Client.UI
{
    public partial class SearchControl : UserControl
    {
        ...
        public List<ServerIdentity> ServerIdentities = new List<ServerIdentity>();
        ...
        private void ChangeDescription(Author author)
        {
            ...
            UIMusicTags.Text = "";
            UIProvider.Text = author.Provider.IPEndPoint.ToString();
        ...
        private void ChangeDescription(Album album)
        {
            ...
            UIMusicTags.Text = "";
            UIProvider.Text = album.Provider.IPEndPoint.ToString();
        ...
        private void ChangeDescription(Music music)
        {
            ...
            UIProvider.Text = music.Provider.IPEndPoint.ToString();
